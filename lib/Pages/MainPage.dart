                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: GNav(
                              ...
                              iconSize: 24,
                              padding: EdgeInsets.symmetric(horizontal: 15, vertical: 6.7),
                              ...
                              tabs: [
                                ...
                                GButton(
                                  ...
                                  leading:
                                  _selectedIndex == 1 || snapshot.data.docs.length == 0
                                      ? null
                                      : Badge(
                                      ...
                                      elevation: 0,
                                      position:
                                      BadgePosition.topEnd(top: -3,end: -2),
                                      child: Icon(
                                        Icons_foodApp.order,
                                        color: Colors.white,
                                      )
                                ...
                                GButton(
                                  ...
                                  leading: cartFood.itemCount == 0 || _selectedIndex == 2
                                      ? null
                                      : Badge(
                                      animationType: BadgeAnimationType.scale,
                                      animationDuration: Duration(milliseconds: 400),
